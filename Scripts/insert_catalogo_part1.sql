...
INSERT INTO PersonPosition (idPersonPosition, descriptionPersonPosition, userCreation, lastUser, lastDate, dateCreation) 
VALUES (s_personPosition.NEXTVAL, 'TÃ©cnico', NULL, NULL, NULL, NULL);
INSERT INTO PersonPosition (idPersonPosition, descriptionPersonPosition, userCreation, lastUser, lastDate, dateCreation) 
VALUES (s_personPosition.NEXTVAL, 'Cuerpo TÃ©cnico', NULL, NULL, NULL, NULL);
INSERT INTO PersonPosition (idPersonPosition, descriptionPersonPosition, userCreation, lastUser, lastDate, dateCreation) 
VALUES (s_personPosition.NEXTVAL, 'Ã?rbitro', NULL, NULL, NULL, NULL);
INSERT INTO PersonPosition (idPersonPosition, descriptionPersonPosition, userCreation, lastUser, lastDate, dateCreation) 
VALUES (s_personPosition.NEXTVAL, 'Ã?rbitro de lÃ­nea', NULL, NULL, NULL, NULL);
...
VALUES (s_typeIdentification.NEXTVAL, 'CÃ©dula', 'X-XXXX-XXXX', NULL, NULL, NULL, NULL);
